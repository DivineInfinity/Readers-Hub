  ...
  <el-conatiner>
    ...
    <el-row :gutter="5" class="stats-widget">
        ...
        <el-card class="stat-widget-card">
          <el-row class="review-bar">
            ...
            <el-col :span="20" style="">
              <el-progress :text-inside="true" :stroke-width="30" :percentage="ratings.fiveStar" class="progress"
          ...
          <el-row class="review-bar">
            ...
            <el-col :span="20">
              <el-progress :text-inside="true" :stroke-width="30" :percentage="ratings.fourStar"
          ...
          <el-row class="review-bar">
            ...
            <el-col :span="20">
              <el-progress :text-inside="true" :stroke-width="30" :percentage="ratings.threeStar" class="progress"
          ...
          <el-row class="review-bar">
            ...
            <el-col :span="20">
              <el-progress :text-inside="true" :stroke-width="30" :percentage="ratings.twoStar" class="progress"
                           color="#cdd040"></el-progress>
            </el-col>
          </el-row>
          <el-row class="review-bar">
            <el-col :span="2">1<i class="el-icon-star-on"></i></el-col>
            <el-col :span="20">
              <el-progress :text-inside="true" :stroke-width="30" :percentage="ratings.oneStar" class="progress"
                           color="#ce492b"></el-progress>
            </el-col>
          </el-row>
      ...
      <el-col :span="10" :xs="24">
        <el-card class="stat-widget-card">
          ...
          <el-rate v-model="book.avgRating" disabled show-score text-color="#ff9900"
                   score-template="{value} rating"></el-rate>
    ...
    <el-row>
      <el-col :span="24" v-for="(review,index) in reviews" :key=index>
        <el-card
          v-bind:class="{ 'review-widget-expanded': review.isExpanded, 'review-widget-collapsed': !review.isExpanded }">
          <el-row>
        ...
        <el-button type="info" v-if="review.review.length>100 && review.isExpanded===false"
                   style="width:100%;background-color:ghostwhite;color:black" @click="toggleExpand(index)">View More
        </el-button>
        <el-button type="info" v-if="review.isExpanded===true"
                   style="width:100%;background-color:ghostwhite;color:black" @click="toggleExpand(index)">View Less
        </el-button>
      </el-col>
    </el-row>
  </el-conatiner>
